...
void MPU6000_Init(void)
{
    ...
    //MPU6000_SPI_write(MPUREG_GYRO_CONFIG,BITS_FS_250DPS);  // Gyro scale 250º/s
    delay(1);
    MPU6000_SPI_write(MPUREG_ACCEL_CONFIG,0x08);            // Accel scale 4g (4096LSB/g)//8192 on later chips
    delay(1);   
